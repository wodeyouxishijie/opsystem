...
public class ContainerWrapperBean {
                ...
                if (tomcatContainer == null) {
                    ...
                    for (int i = 0; i < adaptorClasses.size(); i++) {
                        ...
                        try {
                            ...
                            if (o instanceof AbstractTomcatContainer) {
    ...
    public List getPrivateDataSources() throws Exception {
        ...
        if (tomcatContainer != null && getResourceResolver().supportsPrivateResources()) {
            ...
            for (int i = 0; i < apps.size(); i++) {
                List<ApplicationResource> appResources = getResourceResolver().getApplicationResources((Context) apps.get(i));
    ...
    protected void filterDataSources(List<ApplicationResource> resources, List<ApplicationResource> dataSources) {
        for (Iterator<ApplicationResource> it = resources.iterator(); it.hasNext(); ) {
